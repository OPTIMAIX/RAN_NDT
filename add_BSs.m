...
%
% (c) 2021 - Mobile Communications Research Group - UPC
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
clear all;
rng(700);
name_scenario_buildings_file='ScenarioBuildings.mat';
...
dcorr_penetration=7; %m Table 7.5-6 of 3GPP TR 38.901 - correlation distance - SF - O2I
...
for n=1:numBS
    ...
    map_NLOS_model = genera_map_NLOS(sizeX,sizeY,pixel_size,resolution_dist_NLOS,dist_max_NLOS,BS(n).pos,model,hUT,f,10*n);
...
for n=1:numBS
    ...
    for i=1:sizeX
        for j=1:sizeY
            ...
            for flo=1:num_floors
                BS(n).map_PL{flo}(i,j)= prop_model(dist,model,f,hUT_total(flo),hBS,hE,BS(n).map_NLOS(i,j),map_indoor_points(i,j),BS(n).map_indoor_distances(i,j));     
